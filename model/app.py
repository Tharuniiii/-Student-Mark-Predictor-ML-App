...
app = Flask(__name__)
model = joblib.load(r"C:\Users\Tharuni\Desktop\NIT\sept month\16th,17th_ML Project\student_mark_prediction_project\model\student_mark_prediction.pkl")
...
def predict():
    print("✅ /predict route called!")   # Debug line
    global df
